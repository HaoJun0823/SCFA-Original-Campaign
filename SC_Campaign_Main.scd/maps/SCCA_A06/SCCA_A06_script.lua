#****************************************************************************
#**
#**  File     :  /maps/SCCA_A06/SCCA_A06_script.lua
...
local OpStrings = import ('/maps/SCCA_A06/SCCA_A06_strings.lua')
...
function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation( 'SCCA_A06', false, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
function WinGame()
    ...
    ScenarioFramework.EndOperation( 'SCCA_A06', true, ScenarioInfo.Options.Difficulty, true, true, true, 2 ) #, bonus )
end

function OnCtrlF4()
    ScenarioFramework.EndOperation( 'SCCA_A06', true, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
#    ScenarioFramework.EndOperation('SCCA_A06', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
