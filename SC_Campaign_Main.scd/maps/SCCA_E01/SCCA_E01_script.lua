#****************************************************************************
#**
#**  File     :  /maps/SCCA_E01/SCCA_E01_script.lua
...
local OpStrings = import('/maps/SCCA_E01/SCCA_E01_strings.lua')
...
function KillGame()
    ...
    ScenarioFramework.EndOperation('SCCA_E01', ScenarioInfo.OpComplete, ScenarioInfo.Options.Difficulty,
        ScenarioInfo.OpComplete, secondaries)
end
...
#function OnCtrlF3()
#    ScenarioInfo.OpComplete = true
#    ScenarioFramework.EndOperation('SCCA_E01', ScenarioInfo.OpComplete, ScenarioInfo.Options.Difficulty, true, true, true)
#end
#
#function OnShiftF3()
#    ScenarioInfo.OpComplete = false
#    ScenarioFramework.EndOperation('SCCA_E01', ScenarioInfo.OpComplete, ScenarioInfo.Options.Difficulty, false, false, false)
#end
#
#function OnCtrlAltF5()
#    ScenarioFramework.EndOperation('SCCA_E01', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
#
#function OnCtrlAltF4()
#    ScenarioFramework.EndOperation('SCCA_E01', false, ScenarioInfo.Options.Difficulty, false, false, false)
#end
