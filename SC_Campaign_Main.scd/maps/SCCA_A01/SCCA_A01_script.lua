#****************************************************************************
#**
#**  File     :  /maps/SCCA_A01/SCCA_A01_script.lua
#**  Author(s):  Greg
#**
#**  Summary  :
#**
...
local OpStrings   = import('/maps/SCCA_A01/SCCA_A01_Strings.lua')
...
function CreateCommander()
    ...
    WaitSeconds(1)
    #Player Commander
    ScenarioInfo.PlayerCommander = ScenarioUtils.CreateArmyUnit ( 'Player', 'Player_Commander' )
...
function BeginOperation()
    ...
    ScenarioFramework.CreateUnitDestroyedTrigger( PlayerCommanderDies_Lose, ScenarioInfo.PlayerCommander )
...
function KillGame_Win()
    ...
    ScenarioFramework.EndOperation('SCCA_A01', true, ScenarioInfo.Options.Difficulty, true, secondaries )
end

function KillGame_Fail()
    ScenarioFramework.Dialogue(ScenarioStrings.OpFail, false, true)
    WaitSeconds(9.0)
    ScenarioFramework.EndOperation('SCCA_A01', false, ScenarioInfo.Options.Difficulty, false, false )
end
...
#    ScenarioFramework.EndOperation('SCCA_A01', true, ScenarioInfo.Options.Difficulty, true, true )
#end
