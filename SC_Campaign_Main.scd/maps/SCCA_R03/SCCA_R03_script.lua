#****************************************************************************
#**
#**  File     :  /maps/SCCA_R03/SCCA_R03_script.lua
...
local OpStrings = import ('/maps/SCCA_R03/SCCA_R03_strings.lua')
...
function WinGame()
    ...
    ScenarioFramework.EndOperation('SCCA_R03', true, ScenarioInfo.Options.Difficulty, true, secondaries)
end

function LoseGame()
    WaitSeconds(10)
    ScenarioFramework.EndOperation('SCCA_R03', false, ScenarioInfo.Options.Difficulty, false, false)
end
...
#    ScenarioFramework.EndOperation('SCCA_R03', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
#
#function OnCtrlF4()
#    ScenarioFramework.EndOperation('SCCA_R03', true, ScenarioInfo.Options.Difficulty, false, false, false)
#end
#
#function OnF4()
#    StartMission2()
