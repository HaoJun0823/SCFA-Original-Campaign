#****************************************************************************
#**
#**  File     :  /maps/SCCA_E04/SCCA_E04_operation.lua
...
opID = 'SCCA_E04'						# should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
...
# DO NOT EDIT
local opVars = import('/lua/sc_campaign/operationvars.lua').MakeOpVars(opID, 'uef', 4)
