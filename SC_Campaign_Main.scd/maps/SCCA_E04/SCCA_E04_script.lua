#****************************************************************************
#**
#**  File     :  /maps/SCCA_E04/SCCA_E04_script.lua
#**  Author(s):  Matt Mahon
#**
#**  Summary  :
#**
...
local OpStrings = import ('/maps/SCCA_E04/SCCA_E04_strings.lua')
local EditorFunctions = import('/maps/SCCA_E04/SCCA_E04_EditorFunctions.lua')
...
function StartMission1()
    ...
    ScenarioFramework.AddRestriction( ScenarioInfo.Player, categories.TECH3 - categories.ueb0302 - categories.urb0302 -  categories.uea0302 - categories.ura0302)
    #prevent building t2 restricted units
    ScenarioFramework.AddRestriction( ScenarioInfo.Player, M1UEFTech2NotAllowed )
    #prevent building cybran t2 restricted units, should the player capture cybran engineers
    ScenarioFramework.AddRestriction( ScenarioInfo.Player, M1CybranTech2NotAllowed )
...
function M1StartAirAttackTimer ()
    #Called from SCCA_E04_EditorFunctions
...
function StartMission2()
    ...
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.uea0303 +
                                                 categories.ura0303 )

    #unlock TML's
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.ueb2108 +
                                                 categories.urb2108 )
...
function M2OnLAITimer()
    #unlock T2 artillary
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.ueb2303 + categories.urb2303 )
...
function M2OnSheildsTimer()
    #unlock T2 shields
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.ueb4202 + categories.urb4202 )
...
function M2OnAMDTimer()
    ...
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.ueb4201 + categories.urb4201 )
    if (not Objectives.IsComplete(ScenarioInfo.M2P3)) then
...
function StartMission3()
    ...
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.uea0304 + categories.ura0304 )

    #unlock T2 transports
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.uea0104 + categories.ura0104 )

    #unlock Radar Jammer
    ScenarioFramework.RemoveRestriction( ScenarioInfo.Player, categories.ueb4203 + categories.urb4203 )
...
function WinGame()
    ...
    LOG ('debug matt: comleted mission '..'SCCA_E04'..ScenarioInfo.Options.Difficulty,secondaries )

    ScenarioFramework.EndOperation('SCCA_E04', true, ScenarioInfo.Options.Difficulty, true, secondaries)
end

function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation('SCCA_E04', false, ScenarioInfo.Options.Difficulty, false, false)
end
...
#    ScenarioFramework.EndOperation('SCCA_E04', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
