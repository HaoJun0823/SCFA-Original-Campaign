#****************************************************************************
#**
#**  File     :  /maps/SCCA_E03/SCCA_E03_script.lua
...
local OpStrings = import('/maps/SCCA_E03/SCCA_E03_strings.lua')
...
function KillGame()
    ...
    ScenarioFramework.EndOperation('SCCA_E03', ScenarioInfo.OpComplete, ScenarioInfo.Options.Difficulty, ScenarioInfo.OpComplete, secondaries)
end
...
#    ScenarioFramework.EndOperation('SCCA_E03', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end