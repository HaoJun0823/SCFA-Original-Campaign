...
function OnStart(self)
    ...
    ScenarioFramework.AddRestriction(player, categories.urb2305 +   # Strategic Missile Launcher
    ...
    ScenarioFramework.AddRestriction(uef, categories.ueb2302 +  # Long Range Heavy Artillery
    ...
    ScenarioFramework.AddRestriction(aeon, categories.uab0304 + # Quantum Gate
...
#        ScenarioFramework.EndOperationCamera(ScenarioInfo.PlayerCDR)
        ...
        ScenarioFramework.Dialogue(OpStrings.C06_D01_010, StartKillGame, true)
    end
end
...
function KillGame()
    ...
    ScenarioFramework.EndOperation('SCCA_R06', ScenarioInfo.OpComplete, ScenarioInfo.Options.Difficulty,
...
#    ScenarioFramework.EndOperation('SCCA_R06', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end