#****************************************************************************
#**
#**  File     :  /maps/SCCA_E05/SCCA_E05_script.lua
...
local OpStrings = import ('/maps/SCCA_E05/SCCA_E05_strings.lua')
local OpEditorFns = import ('/maps/SCCA_E05/SCCA_E05_EditorFunctions.lua')
...
#                ScenarioFramework.EndOperationCamera( ScenarioInfo.PlayerCDR, false )
                ...
                ScenarioInfo.CommanderThroughTheGate = true
                PlayerWin()
            end
        )
...
function M3P3Reminder()
    while not ScenarioInfo.CommanderThroughTheGate do
...
function WinGame()
    ...
    ScenarioFramework.EndOperation('SCCA_E05', true, ScenarioInfo.Options.Difficulty, true, secondaries)
end

function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation('SCCA_E05', false, ScenarioInfo.Options.Difficulty, false, false)
end
...
#
#function OnShiftF3()
#    LOG('debug: Op: ShiftF3')
#    FirstNukeNIS()
#end
#
#function OnF4()
#    LOG('debug: Op: F4')
#    # Destroy all units in the LRA bases
#    for k, unit in ScenarioInfo.CybranLRA1BaseBuildings do
#        unit:Destroy()
#    end
#    for k, unit in ScenarioInfo.CybranLRA2BaseBuildings do
#        unit:Destroy()
#    end
#end
#
#function OnShiftF4()
#    LOG('debug: Op: ShiftF4')
#    ForkThread(CreateTruckGroup)
#end
#
#function OnShiftF5()
#    LOG('debug: Op: ShiftF5')
#    ForkThread (AeonTripleNukeAttack)
#    #! Debug armies
#    #ScenarioInfo.DebugPlayer = ScenarioUtils.CreateArmyGroup( 'Player', 'Debug' )
#    #ScenarioInfo.DebugAeon = ScenarioUtils.CreateArmyGroup( 'Aeon', 'Debug' )
#    #ForkThread(AeonContinuedNukeAttacks)
#end
#
#function OnCtrlF5()
...
#    ScenarioFramework.EndOperation('SCCA_E05', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
