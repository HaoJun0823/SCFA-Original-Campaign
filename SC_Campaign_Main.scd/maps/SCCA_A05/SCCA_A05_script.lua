#****************************************************************************
#**
#**  File     :  /maps/SCCA_A05/SCCA_A05_script.lua
...
local OpStrings = import('/maps/SCCA_A05/SCCA_A05_Strings.lua')
...
function WinGame()
    ...
    ScenarioFramework.EndOperation('SCCA_A05', true, ScenarioInfo.Options.Difficulty, true, secondaries, bonus)
end

function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation('SCCA_A05', false, ScenarioInfo.Options.Difficulty, false, false, false)
end
...
#    ScenarioFramework.EndOperation('SCCA_A05', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
