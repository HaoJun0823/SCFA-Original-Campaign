#*****************************************************************************
#*
#*	File: maps/SCCA_A05/SCCA_A05_operation.lua
#*	Author: Drew Staltman
#*     Summary: Operation data for SCCA_A05
#*
...
opID = 'SCCA_A05'						# should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
opLoc = {x = 435, y = 221}			# location of op 'planet' on op select screen
opDesc = ''							# used in op select screen

# DO NOT EDIT
local opVars = import('/lua/sc_campaign/operationvars.lua').MakeOpVars(opID, 'aeon', 5)
