#****************************************************************************
#**
#**  File     :  /maps/SCCA_R01/SCCA_R01_script.lua
#**  Author(s):  Greg
#**
#**  Summary  :
#**
...
local OpStrings   = import('/maps/SCCA_R01/SCCA_R01_Strings.lua')
...
function CreatePlayerCommander()
    #CDR
    ScenarioInfo.PlayerCommander = ScenarioUtils.CreateArmyUnit ( 'Player', 'M1PlayerCDR' )
...
function KillGame_Win()
    WaitSeconds(10.0)
    ScenarioFramework.EndOperation('SCCA_R01', true, ScenarioInfo.Options.Difficulty, true, true )
end

function KillGame_Fail()
        WaitSeconds(10.0)
    ScenarioFramework.EndOperation('SCCA_R01', false, ScenarioInfo.Options.Difficulty, false, false)
end
...
# ---------------
#function OnCtrlF4()
#    #ScenarioFramework.EndOperation('SCCA_R01', true, ScenarioInfo.Options.Difficulty, false, false )
#    print('Ctrl f4')
#    BeginPart2()
#end
#
