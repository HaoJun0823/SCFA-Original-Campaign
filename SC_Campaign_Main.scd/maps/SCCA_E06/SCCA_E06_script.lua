#****************************************************************************
#**
#**  File     :  /maps/SCCA_E06/SCCA_E06_script.lua
#**  Author(s):  Drew Staltman
#**
#**  Summary  : Main mission flow script for SCCA_E06
#**
...
local OpStrings = import('/maps/SCCA_E06/SCCA_E06_Strings.lua')
...
function WinGame()
    ...
    ScenarioFramework.EndOperation('SCCA_E06', true, ScenarioInfo.Options.Difficulty, true, secondaries,true, 1) # number at end if faction for movie
end

function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation('SCCA_E06', false, ScenarioInfo.Options.Difficulty, false, false, false)
end
...
function OnCtrlAltF5()
    ScenarioFramework.EndOperation('SCCA_E06', true, ScenarioInfo.Options.Difficulty, true, true, true)
end
