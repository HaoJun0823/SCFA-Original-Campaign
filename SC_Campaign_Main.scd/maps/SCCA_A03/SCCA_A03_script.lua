#****************************************************************************
#**
#**  File     :  /maps/SCCA_A03/SCCA_A03_script.lua
...
local OpStrings = import('/maps/SCCA_A03/SCCA_A03_strings.lua')
...
function KillGame()
    ...
    ScenarioFramework.EndOperation('SCCA_A03', ScenarioInfo.OpComplete, ScenarioInfo.Options.Difficulty,
...
#    ScenarioFramework.EndOperation('SCCA_A03', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end