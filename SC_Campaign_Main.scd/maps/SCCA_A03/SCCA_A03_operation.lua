#****************************************************************************
#**
#**  File     :  /maps/SCCA_A03/SCCA_A03_operation.lua
...
opID = 'SCCA_A03'						# should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
opLoc = {x = 106, y = 345}			# location of op 'planet' on op select screen
opDesc = ''							# used in op select screen

# DO NOT EDIT
local opVars = import('/lua/sc_campaign/operationvars.lua').MakeOpVars(opID, 'aeon', 3)
