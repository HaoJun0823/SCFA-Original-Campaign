#****************************************************************************
#**
#**  File     :  /maps/SCCA_R04/SCCA_R04_script.lua
...
local OpStrings = import ('/maps/SCCA_R04/SCCA_R04_strings.lua')
...
#local M1B1BuildAmount = 500 # more than this number
...
local M1P2InitialReminderDelay = 300
local M1P2ReoccuringReminderDelay = 600
...
# How long to delay between reminders
local M2P1InitialReminderDelay = 300
...
function OnStart(self)
    ...
    ScenarioFramework.AddRestriction( Player, categories.TECH3 +  # All T3 units
...
function BeginMission1()
    ...
    IssueMove({ ScenarioInfo.Commander }, ScenarioUtils.MarkerToPosition( 'M1_Commander_Walk_2' ))
end
...
function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation( 'SCCA_R04', false, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
function WinGame()
    ...
    ScenarioFramework.EndOperation( 'SCCA_R04', true, ScenarioInfo.Options.Difficulty, true, secondary ) #, bonus )
end

function OnCtrlF4()
    ScenarioFramework.EndOperation( 'SCCA_R04', true, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
#        for k, unit in ArmyBrains[Aeon]:GetListOfUnits(categories.AEON, false) do
#            unit:Destroy()
#        end
#        ScenarioInfo.Node1 = ScenarioFramework.GiveUnitToArmy( ScenarioInfo.Node1, Player )
#        ScenarioFramework.CreateUnitDeathTrigger( NodeDied, ScenarioInfo.Node1 )
#        BeginMission2()
#    end
#end
...
#
#function OnShiftF4()
#    ForkThread(LaunchNavalAttack)
#    ForkThread(LaunchLandAttack)
#    ScenarioInfo.VarTable['AttackBase1'] = true
#end
#
#function OnF5()
...
#    ScenarioFramework.EndOperation('SCCA_R04', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
#
