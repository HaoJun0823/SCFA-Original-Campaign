#****************************************************************************
#**
#**  File     :  /maps/SCCA_E02/SCCA_E02_script.lua
...
local OpStrings = import ('/maps/SCCA_E02/SCCA_E02_strings.lua')
...
function PreIntroNIS()
    ...
    ScenarioInfo.Commander:SetCustomName(LOC '{i CDR_Player}')
...
# player destroyed
#    ScenarioFramework.EndOperationCamera( ScenarioInfo.Commander, true )
    ScenarioFramework.CDRDeathNISCamera( ScenarioInfo.Commander )
...
#    # And we're done
#    Cinematics.ExitNISMode()
#    ScenarioFramework.EndOperation('SCCA_E02', true, ScenarioInfo.Options.Difficulty, false, false, false)
#end
...
function LoseGame()
    WaitSeconds( 5 )
    ScenarioFramework.EndOperation( 'SCCA_E02', false, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
function WinGame()
    ...
    ScenarioFramework.EndOperation( 'SCCA_E02', true, ScenarioInfo.Options.Difficulty, true, secondary ) #, bonus )
end
...
#
#function OnShiftF3()
##    LOG( 'ScenarioInfo.AttackPlatoonsAlive = ', ScenarioInfo.AttackPlatoonsAlive )
#    PlayRandomTaunt()
#end
#
#function OnF4()
#    ScenarioInfo.StopPeriodicAttacks = true
#    for k, unit in ScenarioInfo.M1GroundPatrol01 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol02 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol03 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol04 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol05 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol06 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol07 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1GroundPatrol08 do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1AirPatrol01:GetPlatoonUnits() do
#        unit:Kill()
#    end
#    for k, unit in ScenarioInfo.M1AirPatrol02:GetPlatoonUnits() do
#        unit:Kill()
#    end
#
#    BeginMission3()
...
#function OnF5()
#    local currentHealthPercentage = math.floor(( ScenarioInfo.ResearchFacility:GetHealth() * 100 ) / ScenarioInfo.ResearchFacility:GetMaxHealth() )
#    LOG( '*** CURRENT HEALTH PERCENTAGE IS ', currentHealthPercentage, ', ResearchFacilityHealthThreshold1 is ', ResearchFacilityHealthThreshold1, ' ***' )
#end
#
#function OnCtrlF5()
...
#    ScenarioFramework.EndOperation('SCCA_E02', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
