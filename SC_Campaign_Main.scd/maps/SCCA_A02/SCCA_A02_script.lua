#****************************************************************************
#**
#**  File     :  /maps/SCCA_A02/SCCA_A02_script.lua
...
local OpStrings = import ('/maps/SCCA_A02/SCCA_A02_strings.lua')
...
function LoseGame()
    WaitSeconds( 5 )
    ScenarioFramework.EndOperation( 'SCCA_A02', false, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
function WinGame()
    ...
    ScenarioFramework.EndOperation( 'SCCA_A02', true, ScenarioInfo.Options.Difficulty, true, secondary ) #, bonus )
end

function OnCtrlF4()
    ScenarioFramework.EndOperation( 'SCCA_A02', true, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
#        unit:Destroy()
#    end
#    #if ScenarioInfo.M2P1Objective then ScenarioInfo.M2P1Objective:ManualResult( true ) end
#    #Matt changed to OnExpired for now
#    #if ScenarioInfo.M2P2Objective then ScenarioInfo.M2P2Objective:OnExpired() end
#    #Matt comented out for now
#    #if ScenarioInfo.M2P3Objective then ScenarioInfo.M2P3Objective:ManualResult( true ) end
#    EndMission2()
#end
#
#function OnShiftF4()
#    for k, unit in ScenarioInfo.M3Attackers do
#        if not unit:IsDead() then
#            unit:Kill()
#        end
#    end
...
#    ScenarioFramework.EndOperation('SCCA_A02', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
