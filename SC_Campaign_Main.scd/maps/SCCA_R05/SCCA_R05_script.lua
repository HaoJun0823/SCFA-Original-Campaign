#****************************************************************************
#**
#**  File     :  /maps/SCCA_R05/SCCA_R05_script.lua
#**  Author(s):  Greg
#**
#**  Summary  :
#**
...
local OpStrings   = import('/maps/SCCA_R05/SCCA_R05_Strings.lua')
...
function CreateCommander_Thread()
    ...
    ScenarioInfo.PlayerCommander:SetCustomName('CDR ' .. ArmyBrains[Player].Nickname)
...
function M3_CreateUnitsForMission()
    ...
    ScenarioInfo.M3_UEFMainBase_Commander:CreateEnhancement( 'DamageStablization' )
...
function KillGame_Fail()
    WaitSeconds(7.0)
    ScenarioFramework.EndOperation('SCCA_R05', false, ScenarioInfo.Options.Difficulty, false, false )
end
...
function KillGame_Win()
    ...
    ScenarioFramework.EndOperation('SCCA_R05', true, ScenarioInfo.Options.Difficulty, true, secondaries )
end
...
#    ScenarioFramework.EndOperation('SCCA_R05', true, ScenarioInfo.Options.Difficulty, true, true )
#end
#
