#****************************************************************************
#**
#**  File     :  /maps/SCCA_R02/SCCA_R02_script.lua
...
local OpStrings = import('/maps/SCCA_R02/SCCA_R02_strings.lua')
local OpEditorFns = import ('/maps/SCCA_R02/SCCA_R02_EditorFunctions.lua')
...
function WinGame()
    ...
    ScenarioFramework.EndOperation('SCCA_R02', true, ScenarioInfo.Options.Difficulty, true, secondaries)
end

function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation('SCCA_R02', false, ScenarioInfo.Options.Difficulty, false, false, false)
end
...
#    ScenarioFramework.EndOperation('SCCA_R02', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
