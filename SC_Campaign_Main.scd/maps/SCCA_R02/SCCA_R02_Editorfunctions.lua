#****************************************************************************
#**
#**  File     :  /maps/SCCA_R02/SCCA_R02_EditorFunctions.lua
...
local OpScript = import ('/maps/SCCA_R02/SCCA_R02_script.lua')
    ...
    if(data) then
        ...
        if(data.TableOfMarkers) then
            ...
            # Check brain for Janus vs. Aeon
                ...
                # INVALID ATTACKER!
                    error('*AI WARNING: SCCA_R02/EditorFunctions/ChooseAttackLocation is not using Janus or Aeon!', 2)
                end
            else
            ...
            error('*AI WARNING: SCCA_R02/EditorFunctions/ChooseAttackLocation shows TableOfMarkers not defined', 2)
        end
    else
        error('*AI WARNING: SCCA_R02/EditorFunctions/ChooseAttackLocation shows PlatoonData not defined', 2)
    end
end
